...
class BalloonDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        self.add_class("balloon", 1, "One Punch Man")
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        for i, p in enumerate(info["polygons"]):
            ...
            ## Note : this modifies the existing array arr, instead of creating a result array
            ## 大於mask.shape[0] - 1的全部用mask.shape[0] - 1取代
...
def box_splash(image, r):
    ...
    for index in range(len(rois)):
        ...
        # 畫類别名
        draw.text((x1, y1), "class_name: One Punch Man, score: " + str(score), (255, 255, 255), font=font)
...
def detect_and_color_splash(model, image_path=None, video_path=None):
    ...
    if image_path:
        ...
        # Color splash 原本是splash = color_splash(image, r[‘masks’])
